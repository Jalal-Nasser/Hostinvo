          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                ...
                className="btn-primary px-8 py-4 text-base shadow-[0_8px_40px_rgba(4,141,254,0.55)]"
              >
                {content.primaryCta}
                <svg
                  className="h-4 w-4"
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-[rgba(148,163,184,0.22)] bg-[rgba(255,255,255,0.05)] px-8 py-4 text-base font-semibold text-white backdrop-blur-sm transition hover:bg-[rgba(255,255,255,0.1)]"
              >
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-[rgba(148,163,184,0.22)] bg-[rgba(255,255,255,0.05)] px-8 py-4 text-base font-semibold text-white transition hover:bg-[rgba(255,255,255,0.1)]"
            >
