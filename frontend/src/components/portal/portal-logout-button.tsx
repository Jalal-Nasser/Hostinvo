    ...
    <div className="relative">
      <button
        className={joinClasses(
          "text-[11px] font-medium tracking-[0.14em] text-[#d3def4] transition hover:text-white disabled:cursor-not-allowed disabled:opacity-60",
          className,
        )}
        disabled={isPending}
      ...
      {error ? (
        <p className="absolute end-0 top-full mt-2 whitespace-nowrap text-[11px] text-[#ffb4b4]">
          {error}
        </p>
      ) : null}
    </div>
